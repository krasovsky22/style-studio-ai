...
export function GenerationForm({
  ...
  const estimatedCost = selectedQuality.cost * selectedModel.cost;
  ...
  const validateForm = (): { valid: boolean; errors: string[] } => {
    ...
    if (
      !watchedValues.productImageUrl ||
      watchedValues.productImageUrl.trim() === ""
    ) {
  ...
  const navigateToErrorTab = React.useCallback(() => {
    if (validationErrors.productImageUrl || validationErrors.modelImageUrl) {
      setActiveTab("images");
    }
  }, [validationErrors.productImageUrl, validationErrors.modelImageUrl]);
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger
              value="images"
              className={
                validationErrors.productImageUrl ||
                validationErrors.modelImageUrl
          ...
          <TabsContent value="images" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload the clothing item you want to visualize on a model
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ImageUpload
                  onImageUpload={(url: string) => {
                    ...
                    // Clear validation errors when image is uploaded
            ...
            <Card>
              <CardHeader>
                <CardTitle>Model Image (Optional)</CardTitle>
                <CardDescription>
                  Upload a reference model image for better pose and appearance
                  control
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ImageUpload
                  ...
                  accept={{ "image/*": [".jpg", ".jpeg", ".png", ".webp"] }}
                  maxSize={10 * 1024 * 1024} // 10MB
                  placeholder="Upload model image (optional)"
                  optional
              ...
              <CardContent>
                <StylePresets
                  ...
                  onSelect={(preset: StylePreset) => {
                    ...
                    setValue("style", preset.id as GenerationFormData["style"]);
                  }}
                />
              </CardContent>
            </Card>
              ...
              <CardContent>
                <ModelSelector
                  ...
                  onSelect={(model: AIModel) => {
                    ...
                    setValue("model", model.id as GenerationFormData["model"]);
                  }}
                />
              </CardContent>
            </Card>
